...
contract GeneralStruct {
    ...
    function getMyStruct(address _personIdentifier) public view 
    returns(string memory _name, uint8 _myAge, bool _isMarried, address[] memory _accounts) {
    ...
    function getMyStructWithMultipleReturn(address _personIdentifier) public view 
    returns(string memory, uint8, bool) {
    ...
    function getMyStructWithABIEncoderV2(address _personIdentifier) public view 
